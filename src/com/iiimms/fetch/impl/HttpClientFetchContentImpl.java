...
public class HttpClientFetchContentImpl implements FetchContent {
	...
	public void setDocPostFirstPage() {
		this.docPostFirstPage = HttpClientJsoupDocumentUtil
	...
	public String getContentEachPager(String pageUrl, String postDivQuery,
		...
		// 获取单独每页的文档信息
		Document docEachPage = HttpClientJsoupDocumentUtil.getDocument(pageUrl);
		// 获取每个帖子div的元素集合
